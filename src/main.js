...
securityCode.addEventListener('keyup', (e) => {
    const securityCodeValue = document.querySelector('.cc-security .value');
    securityCodeValue.innerHTML = securityCodeMasked.value;
})
...
expirationDate.addEventListener('keyup', (e) => {
    const expirationDateValue = document.querySelector('.cc-expiration .value');
    expirationDateValue.innerHTML = expirationDateMasked.value;
})
...
cardNumber.addEventListener('keyup', (e) => {
    ...
    cardNumberValue.innerHTML = cardNumberMasked.value;
